...
export const BrushIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.06 11.9 2 22l8.37-2.06M12.42 16.2a2.15 2.15 0 0 1 2.22 2.22l-.1.43a1.5 1.5 0 0 0 1.2 1.9l.48.12a2.15 2.15 0 0 0 2.53-2.53l-.12-.48a1.5 1.5 0 0 0-1.9-1.2l-.43.1a2.15 2.15 0 0 1-2.22-2.22l.34-1.63a2.15 2.15 0 0 0-2.54-2.54l-1.63.34Z"/><path d="m14 7 3 3"/></svg>
);
...
export const FeatherIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"/><path d="M16 8 2 22"/><path d="M17.5 15H9"/></svg>
);
